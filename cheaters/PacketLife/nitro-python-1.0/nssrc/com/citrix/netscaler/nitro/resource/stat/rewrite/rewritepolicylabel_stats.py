...
class rewritepolicylabel_stats(base_resource) :
	ur""" Statistics for rewrite policy label resource.
	"""
	def __init__(self) :
		self._labelname = ""
		self._clearstats = ""
	...
	@property
	def labelname(self) :
		ur"""Name of the rewrite policy label.<br/>Minimum length =  1.
		"""
		try :
	...
	def labelname(self, labelname) :
		ur"""Name of the rewrite policy label.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all rewritepolicylabel_stats resources that are configured on netscaler.
		"""
		try :
