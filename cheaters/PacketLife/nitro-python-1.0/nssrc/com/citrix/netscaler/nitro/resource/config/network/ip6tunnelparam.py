...
class ip6tunnelparam(base_resource) :
	...
	@property
	def srcip(self) :
		ur"""Common source IPv6 address for all IPv6 tunnels. Must be a SNIP6 or VIP6 address.<br/>Minimum length =  1.
		"""
		try :
			return self._srcip
	...
	@property
	def dropfrag(self) :
		ur"""Drop any packet that requires fragmentation.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def dropfragcputhreshold(self) :
		ur"""Threshold value, as a percentage of CPU usage, at which to drop packets that require fragmentation. Applies only if dropFragparameter is set to NO.<br/>Minimum length =  1<br/>Maximum length =  100.
		"""
		try :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update ip6tunnelparam.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of ip6tunnelparam resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the ip6tunnelparam resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = ip6tunnelparam()
