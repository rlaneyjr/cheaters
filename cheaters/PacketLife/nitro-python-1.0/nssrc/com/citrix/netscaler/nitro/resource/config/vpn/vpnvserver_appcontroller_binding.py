...
class vpnvserver_appcontroller_binding(base_resource) :
	...
	def appcontroller(self) :
		ur"""Configured App Controller server in XenMobile deployment.
		"""
		try :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch vpnvserver_appcontroller_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of vpnvserver_appcontroller_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count vpnvserver_appcontroller_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnvserver_appcontroller_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of vpnvserver_appcontroller_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnvserver_appcontroller_binding()
