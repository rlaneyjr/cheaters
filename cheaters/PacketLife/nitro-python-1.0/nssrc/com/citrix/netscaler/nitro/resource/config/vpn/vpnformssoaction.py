...
class vpnformssoaction(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for the form based single sign-on profile.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def actionurl(self) :
		ur"""Root-relative URL to which the completed form is submitted.<br/>Minimum length =  1.
		"""
		try :
	...
	def ssosuccessrule(self) :
		ur"""Use a frequently used expression or create a custom expression describing the action that the form-based single sign-on profile takes when invoked by a policy. Used for verifying successful single sign-on.
		"""
		try :
	...
	def namevaluepair(self) :
		ur"""Other name-value pair attributes to send to the server, in addition to sending the user name and password. Value names are separated by an ampersand (&), such as in name1=value1&name2=value2.
		"""
		try :
	...
	def responsesize(self) :
		ur"""Maximum number of bytes to allow in the response size. Specifies the number of bytes in the response to be parsed for extracting the forms.<br/>Default value: 8096.
		"""
		try :
	...
	@property
	def nvtype(self) :
		ur"""How to process the name-value pair. Available settings function as follows:
	...
	def submitmethod(self) :
		ur"""HTTP method (GET or POST) used by the single sign-on form to send the logon credentials to the logon server.<br/>Default value: GET<br/>Possible values = GET, POST.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add vpnformssoaction.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete vpnformssoaction.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update vpnformssoaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of vpnformssoaction resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the vpnformssoaction resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of vpnformssoaction resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the vpnformssoaction resources configured on NetScaler.
		"""
		try :
			obj = vpnformssoaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of vpnformssoaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnformssoaction()
