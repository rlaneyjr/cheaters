...
class systemcounters(base_resource) :
	...
	def countergroup(self) :
		ur"""Specify the (counter) group name which contains all the counters specific tot his particular group.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the systemcounters resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = systemcounters()
