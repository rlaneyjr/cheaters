...
class aaapreauthenticationpolicy_vpnvserver_binding(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name of the preauthentication policy whose properties you want to view.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch aaapreauthenticationpolicy_vpnvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of aaapreauthenticationpolicy_vpnvserver_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count aaapreauthenticationpolicy_vpnvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = aaapreauthenticationpolicy_vpnvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of aaapreauthenticationpolicy_vpnvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = aaapreauthenticationpolicy_vpnvserver_binding()
