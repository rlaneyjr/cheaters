...
class clusternodegroup_clusternode_binding(base_resource) :
	...
	@property
	def node(self) :
		ur"""Nodes in the nodegroup.<br/>Minimum value =  0<br/>Maximum value =  31.
		"""
		try :
			return self._node
		except Exception as e:
	...
	def get_filtered(cls, service, obj, filter_) :
		ur""" Use this API to fetch filtered set of clusternodegroup_clusternode_binding resources.
	...
	def count(cls, service, obj) :
		ur""" Use this API to count clusternodegroup_clusternode_binding resources configued on NetScaler.
		"""
		try :
			option_ = options()
			option_.count = True
	...
	def count_filtered(cls, service, obj, filter_) :
		ur""" Use this API to count the filtered set of clusternodegroup_clusternode_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			option_ = options()
