...
class gslbvserver_binding(base_resource):
	...
	@property
	def name(self) :
		ur"""Name of the GSLB virtual server.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def gslbvserver_gslbservice_bindings(self) :
		ur"""gslbservice that can be bound to gslbvserver.
		"""
		try :
	...
	def gslbvserver_spilloverpolicy_bindings(self) :
		ur"""spilloverpolicy that can be bound to gslbvserver.
		"""
		try :
	...
	def gslbvserver_domain_bindings(self) :
		ur"""domain that can be bound to gslbvserver.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch gslbvserver_binding resource.
		"""
		try :
