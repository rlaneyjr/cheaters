...
class appfwglobal_binding(base_resource):
	...
	def appfwglobal_appfwpolicy_bindings(self) :
		ur"""appfwpolicy that can be bound to appfwglobal.
		"""
		try :
	...
	def appfwglobal_auditsyslogpolicy_bindings(self) :
		ur"""auditsyslogpolicy that can be bound to appfwglobal.
		"""
		try :
	...
	def appfwglobal_auditnslogpolicy_bindings(self) :
		ur"""auditnslogpolicy that can be bound to appfwglobal.
		"""
		try :
	...
	def get(self, service) :
		ur""" Use this API to fetch a appfwglobal_binding resource .
		"""
		try :
