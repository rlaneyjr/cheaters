...
class sslcertkey_service_binding(base_resource) :
	...
	@property
	def service(self) :
		ur"""Bind the certificate to the named SSL service or service group.
		"""
		try :
	...
	def get(cls, service, certkey) :
		ur""" Use this API to fetch sslcertkey_service_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, certkey, filter_) :
		ur""" Use this API to fetch filtered set of sslcertkey_service_binding resources.
	...
	def count(cls, service, certkey) :
		ur""" Use this API to count sslcertkey_service_binding resources configued on NetScaler.
		"""
		try :
			obj = sslcertkey_service_binding()
			obj.certkey = certkey
	...
	def count_filtered(cls, service, certkey, filter_) :
		ur""" Use this API to count the filtered set of sslcertkey_service_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcertkey_service_binding()
