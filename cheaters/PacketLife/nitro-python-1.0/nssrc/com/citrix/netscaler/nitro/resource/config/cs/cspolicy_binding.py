...
class cspolicy_binding(base_resource):
	...
	def cspolicy_cspolicylabel_bindings(self) :
		ur"""cspolicylabel that can be bound to cspolicy.
		"""
		try :
	...
	def cspolicy_crvserver_bindings(self) :
		ur"""crvserver that can be bound to cspolicy.
		"""
		try :
	...
	def cspolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to cspolicy.
		"""
		try :
	...
	def get(self, service, policyname) :
		ur""" Use this API to fetch cspolicy_binding resource.
		"""
		try :
