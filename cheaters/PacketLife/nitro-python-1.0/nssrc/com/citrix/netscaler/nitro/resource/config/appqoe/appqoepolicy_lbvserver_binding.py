...
class appqoepolicy_lbvserver_binding(base_resource) :
	...
	def bindpriority(self) :
		ur"""Specifies the binding  of the policy. use only in display.
		"""
		try :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch appqoepolicy_lbvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of appqoepolicy_lbvserver_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count appqoepolicy_lbvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = appqoepolicy_lbvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of appqoepolicy_lbvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appqoepolicy_lbvserver_binding()
