...
class aaacertparams(base_resource) :
	...
	def usernamefield(self) :
		ur"""Client certificate field that contains the username, in the format <field>:<subfield>. .
		"""
		try :
	...
	def groupnamefield(self) :
		ur"""Client certificate field that specifies the group, in the format <field>:<subfield>.
		"""
		try :
	...
	@property
	def twofactor(self) :
		ur"""The state of the two-factor authentication.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update aaacertparams.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of aaacertparams resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the aaacertparams resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = aaacertparams()
