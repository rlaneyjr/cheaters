...
class cspolicylabel_binding(base_resource):
	...
	@property
	def labelname(self) :
		ur"""Name of the content switching policy label to display.
		"""
		try :
	...
	def cspolicylabel_cspolicy_bindings(self) :
		ur"""cspolicy that can be bound to cspolicylabel.
		"""
		try :
	...
	def get(self, service, labelname) :
		ur""" Use this API to fetch cspolicylabel_binding resource.
		"""
		try :
