...
class tunnelip6_stats(base_resource) :
	ur""" Statistics for TUNNEL Remote ip6address resource.
	"""
	def __init__(self) :
		self._tunnelip6 = ""
		self._clearstats = ""
	...
	@property
	def tunnelip6(self) :
		ur"""remote IPv6 address of the configured tunnel.<br/>Minimum length =  1.
		"""
		try :
	...
	def tunnelip6(self, tunnelip6) :
		ur"""remote IPv6 address of the configured tunnel.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all tunnelip6_stats resources that are configured on netscaler.
		"""
		try :
			obj = tunnelip6_stats()
			if not name :
