...
class sslcertkey_binding(base_resource):
	...
	@property
	def certkey(self) :
		ur"""Name of the certificate-key pair for which to show detailed information.<br/>Minimum length =  1.
		"""
		try :
	...
	def sslcertkey_crldistribution_bindings(self) :
		ur"""crldistribution that can be bound to sslcertkey.
		"""
		try :
	...
	def sslcertkey_sslvserver_bindings(self) :
		ur"""sslvserver that can be bound to sslcertkey.
		"""
		try :
	...
	def sslcertkey_sslocspresponder_bindings(self) :
		ur"""sslocspresponder that can be bound to sslcertkey.
		"""
		try :
	...
	def sslcertkey_service_bindings(self) :
		ur"""service that can be bound to sslcertkey.
		"""
		try :
	...
	def get(self, service, certkey) :
		ur""" Use this API to fetch sslcertkey_binding resource.
		"""
		try :
