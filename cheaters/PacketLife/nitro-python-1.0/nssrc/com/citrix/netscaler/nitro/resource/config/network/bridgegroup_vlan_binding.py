...
class bridgegroup_vlan_binding(base_resource) :
	...
	def get(cls, service, id) :
		ur""" Use this API to fetch bridgegroup_vlan_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, id, filter_) :
		ur""" Use this API to fetch filtered set of bridgegroup_vlan_binding resources.
	...
	def count(cls, service, id) :
		ur""" Use this API to count bridgegroup_vlan_binding resources configued on NetScaler.
		"""
		try :
			obj = bridgegroup_vlan_binding()
			obj.id = id
	...
	def count_filtered(cls, service, id, filter_) :
		ur""" Use this API to count the filtered set of bridgegroup_vlan_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = bridgegroup_vlan_binding()
