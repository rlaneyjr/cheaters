...
class vpnglobal_vpnnexthopserver_binding(base_resource) :
	...
	def nexthopserver(self) :
		ur"""The name of the next hop server bound to vpn global.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a vpnglobal_vpnnexthopserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		ur""" Use this API to fetch filtered set of vpnglobal_vpnnexthopserver_binding resources.
	...
	def count(cls, service) :
		ur""" Use this API to count vpnglobal_vpnnexthopserver_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_vpnnexthopserver_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of vpnglobal_vpnnexthopserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_vpnnexthopserver_binding()
