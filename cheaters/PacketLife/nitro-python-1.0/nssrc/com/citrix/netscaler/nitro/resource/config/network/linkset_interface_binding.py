...
class linkset_interface_binding(base_resource) :
	...
	@property
	def id(self) :
		ur"""ID of the linkset to which to bind the interfaces.
		"""
		try :
			return self._id
	...
	def get(cls, service, id) :
		ur""" Use this API to fetch linkset_interface_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, id, filter_) :
		ur""" Use this API to fetch filtered set of linkset_interface_binding resources.
	...
	def count(cls, service, id) :
		ur""" Use this API to count linkset_interface_binding resources configued on NetScaler.
		"""
		try :
			obj = linkset_interface_binding()
			obj.id = id
	...
	def count_filtered(cls, service, id, filter_) :
		ur""" Use this API to count the filtered set of linkset_interface_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = linkset_interface_binding()
