...
class systemgroup_systemuser_binding(base_resource) :
	...
	def get(cls, service, groupname) :
		ur""" Use this API to fetch systemgroup_systemuser_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to fetch filtered set of systemgroup_systemuser_binding resources.
	...
	def count(cls, service, groupname) :
		ur""" Use this API to count systemgroup_systemuser_binding resources configued on NetScaler.
		"""
		try :
			obj = systemgroup_systemuser_binding()
			obj.groupname = groupname
	...
	def count_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to count the filtered set of systemgroup_systemuser_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = systemgroup_systemuser_binding()
