...
class netbridge_binding(base_resource):
	...
	def netbridge_nsip6_bindings(self) :
		ur"""nsip6 that can be bound to netbridge.
		"""
		try :
	...
	def netbridge_iptunnel_bindings(self) :
		ur"""iptunnel that can be bound to netbridge.
		"""
		try :
	...
	def netbridge_vlan_bindings(self) :
		ur"""vlan that can be bound to netbridge.
		"""
		try :
	...
	def netbridge_nsip_bindings(self) :
		ur"""nsip that can be bound to netbridge.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch netbridge_binding resource.
		"""
		try :
