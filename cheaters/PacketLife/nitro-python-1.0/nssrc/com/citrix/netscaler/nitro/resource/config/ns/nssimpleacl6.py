...
class nssimpleacl6(base_resource) :
	...
	@property
	def aclname(self) :
		ur"""Name for the simple ACL6 rule. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Cannot be changed after the simple ACL6 rule is created.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def aclaction(self) :
		ur"""Drop incoming IPv6 packets that match the simple ACL6 rule.<br/>Possible values = DENY.
		"""
		try :
	...
	@property
	def srcipv6(self) :
		ur"""IP address to match against the source IP address of an incoming IPv6 packet.
		"""
		try :
	...
	@property
	def destport(self) :
		ur"""Port number to match against the destination port number of an incoming IPv6 packet.
	...
	@property
	def protocol(self) :
		ur"""Protocol to match against the protocol of an incoming IPv6 packet. You must set this parameter if you set the Destination Port parameter.<br/>Possible values = TCP, UDP.
		"""
		try :
	...
	@property
	def ttl(self) :
		ur"""Number of seconds, in multiples of four, after which the simple ACL6 rule expires. If you do not want the simple ACL6 rule to expire, do not specify a TTL value.<br/>Minimum length =  4<br/>Maximum length =  0x7FFFFFFF.
		"""
		try :
			return self._ttl
		except Exception as e:
	...
	@property
	def hits(self) :
		ur"""Number of hits for this SACL6 rule.
		"""
		try :
			return self._hits
		except Exception as e:
	...
	def add(cls, client, resource) :
		ur""" Use this API to add nssimpleacl6.
		"""
		try :
	...
	def clear(cls, client, resource="") :
		ur""" Use this API to clear nssimpleacl6.
		"""
		try :
			if type(resource) is not list :
	...
	def flush(cls, client, resource) :
		ur""" Use this API to flush nssimpleacl6.
		"""
		try :
			if type(resource) is not list :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete nssimpleacl6.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the nssimpleacl6 resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nssimpleacl6()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of nssimpleacl6 resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the nssimpleacl6 resources configured on NetScaler.
		"""
		try :
			obj = nssimpleacl6()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of nssimpleacl6 resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nssimpleacl6()
