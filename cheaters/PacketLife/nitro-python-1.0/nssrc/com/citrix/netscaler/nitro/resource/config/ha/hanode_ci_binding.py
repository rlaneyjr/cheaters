...
class hanode_ci_binding(base_resource) :
	...
	def get(cls, service, id) :
		ur""" Use this API to fetch hanode_ci_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, id, filter_) :
		ur""" Use this API to fetch filtered set of hanode_ci_binding resources.
	...
	def count(cls, service, id) :
		ur""" Use this API to count hanode_ci_binding resources configued on NetScaler.
		"""
		try :
			obj = hanode_ci_binding()
			obj.id = id
	...
	def count_filtered(cls, service, id, filter_) :
		ur""" Use this API to count the filtered set of hanode_ci_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = hanode_ci_binding()
