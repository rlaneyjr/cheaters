...
class authenticationcertpolicy(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for the client certificate authentication policy. 
	...
	@property
	def rule(self) :
		ur"""Name of the NetScaler named rule, or a default syntax expression, that the policy uses to determine whether to attempt to authenticate the user with the authentication server.<br/>Minimum length =  1.
		"""
		try :
			return self._rule
		except Exception as e:
	...
	@property
	def reqaction(self) :
		ur"""Name of the client cert authentication action to be performed if the policy matches.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add authenticationcertpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete authenticationcertpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update authenticationcertpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of authenticationcertpolicy resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the authenticationcertpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of authenticationcertpolicy resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the authenticationcertpolicy resources configured on NetScaler.
		"""
		try :
			obj = authenticationcertpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of authenticationcertpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationcertpolicy()
