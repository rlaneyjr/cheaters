...
class ipset_binding(base_resource):
	...
	@property
	def name(self) :
		ur"""Name of the IP set whose details you want to display.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def ipset_nsip_bindings(self) :
		ur"""nsip that can be bound to ipset.
		"""
		try :
	...
	def ipset_nsip6_bindings(self) :
		ur"""nsip6 that can be bound to ipset.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch ipset_binding resource.
		"""
		try :
