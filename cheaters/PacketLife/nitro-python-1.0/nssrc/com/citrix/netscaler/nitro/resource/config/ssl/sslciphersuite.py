...
class sslciphersuite(base_resource) :
	...
	@property
	def ciphername(self) :
		ur"""Name of the cipher suite for which to show detailed information.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the sslciphersuite resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = sslciphersuite()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of sslciphersuite resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the sslciphersuite resources configured on NetScaler.
		"""
		try :
			obj = sslciphersuite()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of sslciphersuite resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslciphersuite()
