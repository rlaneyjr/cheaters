...
class sslvserver_sslpolicy_binding(base_resource) :
	...
	@property
	def policyname(self) :
		ur"""The name of the SSL policy binding.
		"""
		try :
	...
	def get(cls, service, vservername) :
		ur""" Use this API to fetch sslvserver_sslpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, vservername, filter_) :
		ur""" Use this API to fetch filtered set of sslvserver_sslpolicy_binding resources.
	...
	def count(cls, service, vservername) :
		ur""" Use this API to count sslvserver_sslpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = sslvserver_sslpolicy_binding()
			obj.vservername = vservername
	...
	def count_filtered(cls, service, vservername, filter_) :
		ur""" Use this API to count the filtered set of sslvserver_sslpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslvserver_sslpolicy_binding()
