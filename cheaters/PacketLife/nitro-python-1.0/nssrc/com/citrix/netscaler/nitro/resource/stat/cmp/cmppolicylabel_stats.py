...
class cmppolicylabel_stats(base_resource) :
	ur""" Statistics for compression policy label resource.
	"""
	def __init__(self) :
		self._labelname = ""
		self._clearstats = ""
	...
	@property
	def labelname(self) :
		ur"""Name of the compression policy label for which to display statistics. If not specified, statistics are displayed for all compression policy labels.<br/>Minimum length =  1.
		"""
		try :
	...
	def labelname(self, labelname) :
		ur"""Name of the compression policy label for which to display statistics. If not specified, statistics are displayed for all compression policy labels.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all cmppolicylabel_stats resources that are configured on netscaler.
		"""
		try :
