...
class authenticationcertpolicy_vpnvserver_binding(base_resource) :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch authenticationcertpolicy_vpnvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of authenticationcertpolicy_vpnvserver_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count authenticationcertpolicy_vpnvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = authenticationcertpolicy_vpnvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of authenticationcertpolicy_vpnvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationcertpolicy_vpnvserver_binding()
