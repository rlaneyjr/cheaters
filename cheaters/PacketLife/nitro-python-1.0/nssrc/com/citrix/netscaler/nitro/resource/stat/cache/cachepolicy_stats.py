...
class cachepolicy_stats(base_resource) :
	ur""" Statistics for Integrated Cache policy resource.
	"""
	def __init__(self) :
		self._policyname = ""
		self._clearstats = ""
	...
	@property
	def policyname(self) :
		ur"""Name of the cache policy for which to display statistics. If you do not set this parameter, statistics are shown for all cache policies.<br/>Minimum length =  1.
		"""
		try :
	...
	def policyname(self, policyname) :
		ur"""Name of the cache policy for which to display statistics. If you do not set this parameter, statistics are shown for all cache policies.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all cachepolicy_stats resources that are configured on netscaler.
		"""
		try :
