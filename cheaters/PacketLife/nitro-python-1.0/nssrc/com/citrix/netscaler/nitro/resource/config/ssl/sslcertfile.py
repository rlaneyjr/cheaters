...
class sslcertfile(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name to assign to the imported certificate file. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. The following requirement applies only to the NetScaler CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my file" or 'my file').<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
			return self._name
	...
	@property
	def src(self) :
		ur"""URL specifying the protocol, host, and path, including file name, to the certificate file to be imported. For example, http://www.example.com/cert_file.
	...
	def Import(cls, client, resource) :
		ur""" Use this API to Import sslcertfile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete sslcertfile.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the sslcertfile resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = sslcertfile()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of sslcertfile resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the sslcertfile resources configured on NetScaler.
		"""
		try :
			obj = sslcertfile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of sslcertfile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcertfile()
