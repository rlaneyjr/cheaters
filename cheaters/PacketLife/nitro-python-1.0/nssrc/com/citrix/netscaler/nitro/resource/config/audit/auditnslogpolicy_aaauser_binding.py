...
class auditnslogpolicy_aaauser_binding(base_resource) :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch auditnslogpolicy_aaauser_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of auditnslogpolicy_aaauser_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count auditnslogpolicy_aaauser_binding resources configued on NetScaler.
		"""
		try :
			obj = auditnslogpolicy_aaauser_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of auditnslogpolicy_aaauser_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = auditnslogpolicy_aaauser_binding()
