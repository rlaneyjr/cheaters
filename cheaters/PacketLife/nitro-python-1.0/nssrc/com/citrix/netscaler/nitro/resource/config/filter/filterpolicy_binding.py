...
class filterpolicy_binding(base_resource):
	...
	def filterpolicy_crvserver_bindings(self) :
		ur"""crvserver that can be bound to filterpolicy.
		"""
		try :
	...
	def filterpolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to filterpolicy.
		"""
		try :
	...
	def filterpolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to filterpolicy.
		"""
		try :
	...
	def filterpolicy_filterglobal_bindings(self) :
		ur"""filterglobal that can be bound to filterpolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch filterpolicy_binding resource.
		"""
		try :
