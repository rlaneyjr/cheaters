...
class cmppolicy_stats(base_resource) :
	ur""" Statistics for compression policy resource.
	"""
	def __init__(self) :
		self._name = ""
		self._clearstats = ""
	...
	@property
	def name(self) :
		ur"""Name of the advanced compression policy for which to display statistics. If no name is specified, statistics for all advanced compression polices are shown.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@name.setter
	def name(self, name) :
		ur"""Name of the advanced compression policy for which to display statistics. If no name is specified, statistics for all advanced compression polices are shown.
		"""
		try :
			self._name = name
		except Exception as e:
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all cmppolicy_stats resources that are configured on netscaler.
		"""
		try :
			obj = cmppolicy_stats()
			if not name :
