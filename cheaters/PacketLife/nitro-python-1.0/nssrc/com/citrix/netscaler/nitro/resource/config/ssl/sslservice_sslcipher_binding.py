...
class sslservice_sslcipher_binding(base_resource) :
	...
	def get(cls, service, servicename) :
		ur""" Use this API to fetch sslservice_sslcipher_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, servicename, filter_) :
		ur""" Use this API to fetch filtered set of sslservice_sslcipher_binding resources.
	...
	def count(cls, service, servicename) :
		ur""" Use this API to count sslservice_sslcipher_binding resources configued on NetScaler.
		"""
		try :
			obj = sslservice_sslcipher_binding()
			obj.servicename = servicename
	...
	def count_filtered(cls, service, servicename, filter_) :
		ur""" Use this API to count the filtered set of sslservice_sslcipher_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslservice_sslcipher_binding()
