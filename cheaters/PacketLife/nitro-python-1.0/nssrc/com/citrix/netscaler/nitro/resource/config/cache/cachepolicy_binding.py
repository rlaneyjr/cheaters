...
class cachepolicy_binding(base_resource):
	...
	def cachepolicy_cachepolicylabel_bindings(self) :
		ur"""cachepolicylabel that can be bound to cachepolicy.
		"""
		try :
	...
	def cachepolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to cachepolicy.
		"""
		try :
	...
	def cachepolicy_cacheglobal_bindings(self) :
		ur"""cacheglobal that can be bound to cachepolicy.
		"""
		try :
	...
	def cachepolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to cachepolicy.
		"""
		try :
	...
	def get(self, service, policyname) :
		ur""" Use this API to fetch cachepolicy_binding resource.
		"""
		try :
