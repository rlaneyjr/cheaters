...
class authorizationpolicylabel_stats(base_resource) :
	ur""" Statistics for authorization policy label resource.
	"""
	def __init__(self) :
		self._labelname = ""
		self._clearstats = ""
	...
	@property
	def labelname(self) :
		ur"""Name of the authorization policy label.<br/>Minimum length =  1.
		"""
		try :
	...
	def labelname(self, labelname) :
		ur"""Name of the authorization policy label.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all authorizationpolicylabel_stats resources that are configured on netscaler.
		"""
		try :
