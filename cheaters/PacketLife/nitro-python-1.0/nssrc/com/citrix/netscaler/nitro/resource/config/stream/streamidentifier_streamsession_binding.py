...
class streamidentifier_streamsession_binding(base_resource) :
	...
	def get_filtered(cls, service, obj, filter_) :
		ur""" Use this API to fetch filtered set of streamidentifier_streamsession_binding resources.
	...
	def count(cls, service, obj) :
		ur""" Use this API to count streamidentifier_streamsession_binding resources configued on NetScaler.
		"""
		try :
			option_ = options()
			option_.count = True
	...
	def count_filtered(cls, service, obj, filter_) :
		ur""" Use this API to count the filtered set of streamidentifier_streamsession_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			option_ = options()
