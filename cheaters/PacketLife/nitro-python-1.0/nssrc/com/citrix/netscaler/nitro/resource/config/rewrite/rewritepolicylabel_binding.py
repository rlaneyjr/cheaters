...
class rewritepolicylabel_binding(base_resource):
	...
	def rewritepolicylabel_policybinding_bindings(self) :
		ur"""policybinding that can be bound to rewritepolicylabel.
		"""
		try :
	...
	def rewritepolicylabel_rewritepolicy_bindings(self) :
		ur"""rewritepolicy that can be bound to rewritepolicylabel.
		"""
		try :
	...
	def get(self, service, labelname) :
		ur""" Use this API to fetch rewritepolicylabel_binding resource.
		"""
		try :
