...
class csvserver_authorizationpolicy_binding(base_resource) :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch csvserver_authorizationpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of csvserver_authorizationpolicy_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count csvserver_authorizationpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = csvserver_authorizationpolicy_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of csvserver_authorizationpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = csvserver_authorizationpolicy_binding()
