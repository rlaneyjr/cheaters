...
class aaaglobal_binding(base_resource):
	...
	def aaaglobal_authenticationnegotiateaction_bindings(self) :
		ur"""authenticationnegotiateaction that can be bound to aaaglobal.
		"""
		try :
	...
	def aaaglobal_aaapreauthenticationpolicy_bindings(self) :
		ur"""aaapreauthenticationpolicy that can be bound to aaaglobal.
		"""
		try :
	...
	def get(self, service) :
		ur""" Use this API to fetch a aaaglobal_binding resource .
		"""
		try :
