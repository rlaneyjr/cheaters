...
class gslbdomain_binding(base_resource):
	...
	def gslbdomain_lbmonitor_bindings(self) :
		ur"""lbmonitor that can be bound to gslbdomain.
		"""
		try :
	...
	def gslbdomain_gslbvserver_bindings(self) :
		ur"""gslbvserver that can be bound to gslbdomain.
		"""
		try :
	...
	def gslbdomain_gslbservice_bindings(self) :
		ur"""gslbservice that can be bound to gslbdomain.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch gslbdomain_binding resource.
		"""
		try :
