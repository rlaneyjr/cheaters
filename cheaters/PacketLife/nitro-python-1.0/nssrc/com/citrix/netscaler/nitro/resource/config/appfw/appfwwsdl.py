...
class appfwwsdl(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name of the WSDL file to remove.<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
			return self._name
	...
	@property
	def src(self) :
		ur"""URL (protocol, host, path, and name) of the WSDL file to be imported is stored.
	...
	@property
	def comment(self) :
		ur"""Any comments to preserve information about the WSDL.<br/>Maximum length =  128.
		"""
		try :
	...
	@property
	def overwrite(self) :
		ur"""Overwrite any existing WSDL of the same name.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete appfwwsdl.
		"""
		try :
	...
	def Import(cls, client, resource) :
		ur""" Use this API to Import appfwwsdl.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the appfwwsdl resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = appfwwsdl()
