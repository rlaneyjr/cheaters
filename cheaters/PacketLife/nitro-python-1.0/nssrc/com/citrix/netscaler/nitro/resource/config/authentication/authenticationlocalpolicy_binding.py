...
class authenticationlocalpolicy_binding(base_resource):
	...
	def authenticationlocalpolicy_vpnvserver_bindings(self) :
		ur"""vpnvserver that can be bound to authenticationlocalpolicy.
		"""
		try :
	...
	def authenticationlocalpolicy_systemglobal_bindings(self) :
		ur"""systemglobal that can be bound to authenticationlocalpolicy.
		"""
		try :
	...
	def authenticationlocalpolicy_vpnglobal_bindings(self) :
		ur"""vpnglobal that can be bound to authenticationlocalpolicy.
		"""
		try :
	...
	def authenticationlocalpolicy_authenticationvserver_bindings(self) :
		ur"""authenticationvserver that can be bound to authenticationlocalpolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch authenticationlocalpolicy_binding resource.
		"""
		try :
