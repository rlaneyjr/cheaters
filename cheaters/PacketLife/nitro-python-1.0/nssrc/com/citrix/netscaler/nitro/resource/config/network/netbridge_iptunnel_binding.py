...
class netbridge_iptunnel_binding(base_resource) :
	...
	@property
	def tunnel(self) :
		ur"""The name of the tunnel that is a part of this bridge.
		"""
		try :
			return self._tunnel
		except Exception as e:
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch netbridge_iptunnel_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of netbridge_iptunnel_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count netbridge_iptunnel_binding resources configued on NetScaler.
		"""
		try :
			obj = netbridge_iptunnel_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of netbridge_iptunnel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = netbridge_iptunnel_binding()
