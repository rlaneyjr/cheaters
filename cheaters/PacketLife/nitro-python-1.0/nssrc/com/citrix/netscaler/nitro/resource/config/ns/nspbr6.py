...
class nspbr6(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for the PBR6. Must begin with an ASCII alphabetic or underscore \(_\) character, and must contain only ASCII alphanumeric, underscore, hash \(\#\), period \(.\), space, colon \(:\), at \(@\), equals \(=\), and hyphen \(-\) characters. Can be changed after the PBR6 is created.<br/>Minimum length =  1.
		"""
		try :
			return self._name
