...
class transformpolicy_stats(base_resource) :
	ur""" Statistics for URL Transformation policy resource.
	"""
	def __init__(self) :
		self._name = ""
		self._clearstats = ""
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all transformpolicy_stats resources that are configured on netscaler.
		"""
		try :
