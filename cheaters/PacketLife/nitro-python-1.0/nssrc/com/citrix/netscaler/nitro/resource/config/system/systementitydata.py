...
class systementitydata(base_resource) :
	...
	@property
	def alldeleted(self) :
		ur"""Specify this if you would like to delete information about all deleted entities from the database.
		"""
		try :
	...
	def allinactive(self) :
		ur"""Specify this if you would like to delete information about all inactive entities from the database.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete systementitydata.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the systementitydata resources that are configured on netscaler.
		"""
		try :
			if type(name) == cls :
