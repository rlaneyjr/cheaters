...
class appfwpolicylabel(base_resource) :
	...
	@property
	def labelname(self) :
		ur"""Name for the policy label. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Can be changed after the policy label is created.
	...
	def policylabeltype(self) :
		ur"""Type of transformations allowed by the policies bound to the label. Always http_req for application firewall policy labels.<br/>Possible values = http_req.
		"""
		try :
	...
	@property
	def newname(self) :
		ur"""The new name of the application firewall policylabel.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add appfwpolicylabel.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete appfwpolicylabel.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_labelname) :
		ur""" Use this API to rename a appfwpolicylabel resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the appfwpolicylabel resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of appfwpolicylabel resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the appfwpolicylabel resources configured on NetScaler.
		"""
		try :
			obj = appfwpolicylabel()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of appfwpolicylabel resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwpolicylabel()
