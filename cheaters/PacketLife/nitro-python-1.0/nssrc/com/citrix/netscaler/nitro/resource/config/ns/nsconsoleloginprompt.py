...
class nsconsoleloginprompt(base_resource) :
	...
	def promptstring(self) :
		ur"""Console login prompt string.
		"""
		try :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update nsconsoleloginprompt.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of nsconsoleloginprompt resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the nsconsoleloginprompt resources that are configured on netscaler.
		"""
		try :
			if not name :
