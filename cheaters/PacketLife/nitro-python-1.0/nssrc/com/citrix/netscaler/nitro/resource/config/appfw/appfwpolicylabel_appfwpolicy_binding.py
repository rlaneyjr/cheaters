...
class appfwpolicylabel_appfwpolicy_binding(base_resource) :
	...
	def get(cls, service, labelname) :
		ur""" Use this API to fetch appfwpolicylabel_appfwpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, labelname, filter_) :
		ur""" Use this API to fetch filtered set of appfwpolicylabel_appfwpolicy_binding resources.
	...
	def count(cls, service, labelname) :
		ur""" Use this API to count appfwpolicylabel_appfwpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwpolicylabel_appfwpolicy_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		ur""" Use this API to count the filtered set of appfwpolicylabel_appfwpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwpolicylabel_appfwpolicy_binding()
