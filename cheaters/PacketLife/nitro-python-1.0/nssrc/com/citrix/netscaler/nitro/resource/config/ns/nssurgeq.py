...
class nssurgeq(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name of a virtual server, service or service group for which the SurgeQ must be flushed.
		"""
		try :
			return self._name
	...
	@property
	def servername(self) :
		ur"""Name of a service group member. This argument is needed when you want to flush the SurgeQ of a service group.
		"""
		try :
	...
	@property
	def port(self) :
		ur"""port on which server is bound to the entity(Servicegroup).<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	def flush(cls, client, resource) :
		ur""" Use this API to flush nssurgeq.
		"""
		try :
