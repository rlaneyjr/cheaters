...
class rewritepolicylabel_policybinding_binding(base_resource) :
	...
	@property
	def policyname(self) :
		ur"""Name of the rewrite policy to bind to the policy label.
		"""
		try :
	...
	@property
	def labelname(self) :
		ur"""Name of the rewrite policy label to which to bind the policy.
		"""
		try :
	...
	@property
	def invoke(self) :
		ur"""Suspend evaluation of policies bound to the current policy label, and then forward the request to the specified virtual server or evaluate the specified policy label.
		"""
		try :
			return self._invoke
		except Exception as e:
	...
	def get(cls, service, labelname) :
		ur""" Use this API to fetch rewritepolicylabel_policybinding_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, labelname, filter_) :
		ur""" Use this API to fetch filtered set of rewritepolicylabel_policybinding_binding resources.
	...
	def count(cls, service, labelname) :
		ur""" Use this API to count rewritepolicylabel_policybinding_binding resources configued on NetScaler.
		"""
		try :
			obj = rewritepolicylabel_policybinding_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		ur""" Use this API to count the filtered set of rewritepolicylabel_policybinding_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = rewritepolicylabel_policybinding_binding()
