...
class vpnglobal_authenticationldappolicy_binding(base_resource) :
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a vpnglobal_authenticationldappolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		ur""" Use this API to fetch filtered set of vpnglobal_authenticationldappolicy_binding resources.
	...
	def count(cls, service) :
		ur""" Use this API to count vpnglobal_authenticationldappolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_authenticationldappolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of vpnglobal_authenticationldappolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_authenticationldappolicy_binding()
