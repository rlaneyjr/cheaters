...
class cachepolicylabel_stats(base_resource) :
	ur""" Statistics for cache policy label resource.
	"""
	def __init__(self) :
		self._labelname = ""
		self._clearstats = ""
	...
	@property
	def labelname(self) :
		ur"""Name of the cache-policy label for which to display statistics. If you do not set this parameter statistics are shown for all cache-policy labels.<br/>Minimum length =  1.
		"""
		try :
	...
	def labelname(self, labelname) :
		ur"""Name of the cache-policy label for which to display statistics. If you do not set this parameter statistics are shown for all cache-policy labels.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all cachepolicylabel_stats resources that are configured on netscaler.
		"""
		try :
