...
class feopolicy_binding(base_resource):
	...
	def feopolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to feopolicy.
		"""
		try :
	...
	def feopolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to feopolicy.
		"""
		try :
	...
	def feopolicy_feoglobal_bindings(self) :
		ur"""feoglobal that can be bound to feopolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch feopolicy_binding resource.
		"""
		try :
