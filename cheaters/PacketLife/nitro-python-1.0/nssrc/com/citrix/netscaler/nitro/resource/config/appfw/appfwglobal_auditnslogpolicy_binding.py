...
class appfwglobal_auditnslogpolicy_binding(base_resource) :
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a appfwglobal_auditnslogpolicy_binding resources.
		"""
		try :
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of appfwglobal_auditnslogpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwglobal_auditnslogpolicy_binding()
