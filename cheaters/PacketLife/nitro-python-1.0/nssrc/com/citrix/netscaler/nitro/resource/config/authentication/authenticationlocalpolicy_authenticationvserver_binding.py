...
class authenticationlocalpolicy_authenticationvserver_binding(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name of the local authentication policy.
		"""
		try :
			return self._name
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch authenticationlocalpolicy_authenticationvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of authenticationlocalpolicy_authenticationvserver_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count authenticationlocalpolicy_authenticationvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = authenticationlocalpolicy_authenticationvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of authenticationlocalpolicy_authenticationvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationlocalpolicy_authenticationvserver_binding()
