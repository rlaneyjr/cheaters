...
class linkset(base_resource) :
	...
	@property
	def id(self) :
		ur"""Unique identifier for the linkset. Must be of the form LS/x, where x can be an integer from 1 to 32.
		"""
		try :
			return self._id
	...
	@property
	def ifnum(self) :
		ur"""The interfaces to be bound to the linkset.
		"""
		try :
			return self._ifnum
		except Exception as e:
	...
	def add(cls, client, resource) :
		ur""" Use this API to add linkset.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete linkset.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the linkset resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = linkset()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of linkset resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the linkset resources configured on NetScaler.
		"""
		try :
			obj = linkset()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of linkset resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = linkset()
