...
class rewritepolicy_binding(base_resource):
	...
	def rewritepolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to rewritepolicy.
		"""
		try :
	...
	def rewritepolicy_rewritepolicylabel_bindings(self) :
		ur"""rewritepolicylabel that can be bound to rewritepolicy.
		"""
		try :
	...
	def rewritepolicy_rewriteglobal_bindings(self) :
		ur"""rewriteglobal that can be bound to rewritepolicy.
		"""
		try :
	...
	def rewritepolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to rewritepolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch rewritepolicy_binding resource.
		"""
		try :
