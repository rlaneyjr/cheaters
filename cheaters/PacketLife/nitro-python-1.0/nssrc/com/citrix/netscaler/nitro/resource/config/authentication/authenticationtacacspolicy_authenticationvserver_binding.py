...
class authenticationtacacspolicy_authenticationvserver_binding(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name of the TACACS+ policy.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch authenticationtacacspolicy_authenticationvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of authenticationtacacspolicy_authenticationvserver_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count authenticationtacacspolicy_authenticationvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = authenticationtacacspolicy_authenticationvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of authenticationtacacspolicy_authenticationvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationtacacspolicy_authenticationvserver_binding()
