...
class dnsnsrec(base_resource) :
	...
	@property
	def nameserver(self) :
		ur"""Host name of the name server to add to the domain.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add dnsnsrec.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete dnsnsrec.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the dnsnsrec resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dnsnsrec()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of dnsnsrec resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the dnsnsrec resources configured on NetScaler.
		"""
		try :
			obj = dnsnsrec()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of dnsnsrec resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnsnsrec()
