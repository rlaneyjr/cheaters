...
class transformpolicylabel_transformpolicy_binding(base_resource) :
	...
	def get(cls, service, labelname) :
		ur""" Use this API to fetch transformpolicylabel_transformpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, labelname, filter_) :
		ur""" Use this API to fetch filtered set of transformpolicylabel_transformpolicy_binding resources.
	...
	def count(cls, service, labelname) :
		ur""" Use this API to count transformpolicylabel_transformpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = transformpolicylabel_transformpolicy_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		ur""" Use this API to count the filtered set of transformpolicylabel_transformpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = transformpolicylabel_transformpolicy_binding()
