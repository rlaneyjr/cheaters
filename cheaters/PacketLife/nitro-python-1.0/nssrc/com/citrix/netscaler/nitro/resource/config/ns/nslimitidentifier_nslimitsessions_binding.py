...
class nslimitidentifier_nslimitsessions_binding(base_resource) :
	...
	def get(cls, service, limitidentifier) :
		ur""" Use this API to fetch nslimitidentifier_nslimitsessions_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, limitidentifier, filter_) :
		ur""" Use this API to fetch filtered set of nslimitidentifier_nslimitsessions_binding resources.
	...
	def count(cls, service, limitidentifier) :
		ur""" Use this API to count nslimitidentifier_nslimitsessions_binding resources configued on NetScaler.
		"""
		try :
			obj = nslimitidentifier_nslimitsessions_binding()
			obj.limitidentifier = limitidentifier
	...
	def count_filtered(cls, service, limitidentifier, filter_) :
		ur""" Use this API to count the filtered set of nslimitidentifier_nslimitsessions_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nslimitidentifier_nslimitsessions_binding()
