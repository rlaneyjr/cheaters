    ...
    if (a != undefined) {
        ...
        if (nodeClass != null && !nodeClass.match(/collapsable/)) {
            ...
            if (ulNode != undefined) {
                if (ulNode.hasAttribute("style")) {
                    ulNode.setAttribute("style", "display: block; background-color: #FFFFFF !important;");
                } else {
        ...
        if (b != undefined) {
            ...
            if (style != null && !style.match(/background-color: Background;/)) {
                a.setAttribute("style", "background-color: #FFFFFF;  " + style);
                b.setAttribute("style", "color: black;");
            } else if (style != null) {
                a.setAttribute("style", "background-color: #FFFFFF;  " + style);
                b.setAttribute("style", "color: black;");
            } else {
                a.setAttribute("style", "background-color: #FFFFFF;  ");
                b.setAttribute("style", "color: black;");
            }
        }
