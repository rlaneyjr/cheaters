...
(function(){
    ...
    (function() {
    var p = "2878682", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2878682||'',
    GUID:window.ftGUID_2878682||'99999999999',
    confID:window.ftConfID_2878682||'0',
    ftReturn: window.ftReturn_2878682||'',
    keyword:window.ftKeyword_2878682||'',
    ftId:window.ftId_2878682||'',
    imp:window.ftImp2878682,
    ftImpId:window.ftImp2878682 && window.ftImp2878682.impID || '',
    campaignID:'86754',
    cID:'69005',
    pID:'2878682',
    creativeID:'1638109',
    exttrack:[],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/6/86754;2878682;1638109;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://travel.americanexpress.com/home"],
    placementDescription:'AcquisitionMultilineDynamicFlashtalking728x90RhythmOneCM',
    width:728,
    height:90,
    ...
    divID:'ftdiv2878682',
    phID:'ftpos2878682',
    frameID:'ftframe2878682',
    expID:'ftexpframe2878682',
    altImgID:'ftalt2878682',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/6/86754;2878682;1638109;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://travel.americanexpress.com/home',
    altImg:'http://servedby.flashtalking.com/imp/6/86754;2878682;204;gif;RhythmOne;AcquisitionMultilineDynamicFlashtalking728x90RhythmOneCM/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/6/86754;2878682;271;pixel;RhythmOne;AcquisitionMultilineDynamicFlashtalking728x90RhythmOneCM/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/287/2878682/1638109/js/j-2878682-1638109.js',
    file:'http://cdn.flashtalking.com/69005/1638109/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat6.flashtalking.com/reportV3/ft.stat?101140885-2878682;1638109;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_2878682||'',
    segmentList:window.ftSegmentList_2878682||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp2878682 && window.ftImp2878682.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m2878682')&&/^https:/.test(document.getElementById('ftscript_m2878682').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2878682'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_2878682'],
        ['ftcfid', 'ftConfID_2878682'],
        ['fttime', 'ftTimestamp_2878682'],
        ['ftsection', 'ftSection_2878682'],
        ['ftcustom', 'ftCustom_2878682'],
        ['ft_id', 'ftId_2878682'],
        ['ftimpid','ftImp2878682', 'impID']
    ]
};
