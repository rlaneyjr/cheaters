...
<tr class="header keyboard_key">
    ...
    <td class="name">
        <?php //print $this->makeArrow("name"); ?>
        <a href="
            <?php print $this->makeLink(false, false, null, null, null, ""); ?>
        ">
            <span>
                <?php
                    if (EncodeExplorer::getConfig('main_title') != null)
    ...
    <td class="size">
        <?php //print $this->makeArrow("size");?>
    </td>
    <td class="changed">
        <?php //print $this->makeArrow("mod");?>
    </td>
